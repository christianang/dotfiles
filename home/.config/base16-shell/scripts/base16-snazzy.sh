...
# Snazzy theme based on Hyper-Snazzy (https://github.com/sindresorhus/hyper-snazzy)

color00="33/30/3B" # Base 00 - Black
...
color07="eF/F0/EB" # Base 05 - White
color08="4F/4B/58" # Base 03 - Bright Black
...
color_foreground="EF/F0/EB" # Base 05
